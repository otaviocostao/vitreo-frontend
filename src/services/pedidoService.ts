...
import type { PedidoPayload, PedidoResponse, PedidoUpdatePayload, StatusPedido } from '../types/pedido';
import api from './api';
...
export const updatePedidoStatus = async (id: string, status: StatusPedido): Promise<void> => {
  try {
